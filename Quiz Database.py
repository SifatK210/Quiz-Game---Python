//QUESTIONS FOR QUIZ --
question_bank=[
    {"text":"The ability of one class to acquire methods and attributes from another class is called ___________.","answer":"A"},
...
options=[["A. Inheritance","B. Abstraction","C. Polymorpphism","D. Objects"],
